...
#     "table"          -> per-order eta_s/eta_p interpolated at the ray lambda
...
# ---------------------------------------------------------------------------
def order_efficiencies(spec, lam, cos_i, orders):
...
def apply_to_batch(tracer, fid, grp):
    ...
    eta_s, eta_p = order_efficiencies(spec, grp.lam, cos_i, orders)
